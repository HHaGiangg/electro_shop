    ...
    <aside id="side-overlay">
        ...
        <div class="content-header border-bottom">
            ...
            <a class="img-link mr-1" href="javascript:void(0)">
                <img class="img-avatar img-avatar32" src="{{ asset('backend/assets/media/avatars/avatar10.jpg')}}" alt="">
            </a>
            <!-- END User Avatar -->
            <!-- User Info -->
            <div class="ml-2">
                            ...
                            <div class="block-content">
                                ...
                                <ul class="nav-items mb-0">
                                    ...
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar16.jpg')}}" alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a class="media py-2" href="javascript:void(0)">
                                            <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                                <img class="img-avatar img-avatar48" src="{{ asset('backend/assets/media/avatars/avatar14.jpg')}}" alt="">
                                                <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                            </div>
                                            <div class="media-body">
            ...
            <div>
                ...
                <div class="dropdown d-inline-block ml-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-right font-size-sm smini-hide border-0" aria-labelledby="sidebar-themes-dropdown">
                        ...
                        <a class="dropdown-item d-flex align-items-center justify-content-between font-w500" data-toggle="theme" data-theme="{{ asset('backend/assets/css/themes/amethyst.min.css')}}" href="#">
                            <span>Amethyst</span>
                            <i class="fa fa-circle text-amethyst"></i>
                        </a>
                        <a class="dropdown-item d-flex align-items-center justify-content-between font-w500" data-toggle="theme" data-theme="{{ asset('backend/assets/css/themes/city.min.css')}}" href="#">
                            <span>City</span>
                            <i class="fa fa-circle text-city"></i>
                        </a>
                        <a class="dropdown-item d-flex align-items-center justify-content-between font-w500" data-toggle="theme" data-theme="{{ asset('backend/assets/css/themes/flat.min.css')}}" href="#">
                            <span>Flat</span>
                            <i class="fa fa-circle text-flat"></i>
                        </a>
                        <a class="dropdown-item d-flex align-items-center justify-content-between font-w500" data-toggle="theme" data-theme="{{ asset('backend/assets/css/themes/modern.min.css')}}" href="#">
                            <span>Modern</span>
                            <i class="fa fa-circle text-modern"></i>
                        </a>
                        <a class="dropdown-item d-flex align-items-center justify-content-between font-w500" data-toggle="theme" data-theme="{{ asset('backend/assets/css/themes/smooth.min.css')}}" href="#">
                            <span>Smooth</span>
            ...
            <div class="content-side">
                <ul class="nav-main">
                    <li class="nav-main-item">
                        <a class="nav-main-link active" href="{{ route('get_backend.home') }}">
                    ...
                    <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('get_backend.category.index') }}">
                                    <span class="nav-main-link-name">Danh mục sản phẩm</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('get_backend.product.index') }}">
                                    <span class="nav-main-link-name">Sản phẩm</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('get_backend.keyword.index') }}">
                                    <span class="nav-main-link-name">Từ khóa sản phẩm</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('get_backend.menu.index') }}">
                                    <span class="nav-main-link-name">Danh mục bài viết</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('get_backend.article.index') }}">
                                    <span class="nav-main-link-name">Bài viết</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('get_backend.tag.index') }}">
                                    <span class="nav-main-link-name">Tag bài viết</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-main-heading">Album</li>
                    <li class="nav-main-item">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                            <i class="nav-main-link-icon si si-layers"></i>
                            <span class="nav-main-link-name">Ảnh</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('get_backend.slide.index') }}">
                                    <span class="nav-main-link-name">Ảnh Slide</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown d-inline-block ml-2">
                    <button type="button" class="btn btn-sm btn-dual d-flex align-items-center" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="d-none d-sm-inline-block ml-2">{{ get_data_user('admins','name') }}</span>
                        <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block ml-1 mt-1"></i>
                    </button>
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                        <div class="p-3 text-center bg-primary-dark rounded-top">
                            <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ asset('backend/assets/media/avatars/avatar10.jpg')}}" alt="">
                            <p class="mt-2 mb-0 text-white font-w500">{{ get_data_user('admins','name') }}</p>
                            <p class="mb-0 text-white-50 font-size-sm">{{ get_data_user('admins','address') }}</p>
                        </div>
                        <div class="p-2">
...
{{--                            </a>--}}
                            <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('get_admin.logout') }}">
                                <span class="font-size-sm font-w500">Đăng xuất</span>
                            </a>
                        </div>
                    </div>
                </div>
...
{{--                            Welcome <a class="font-w600" href="javascript:void(0)">Admin</a>, everything looks great.--}}
{{--                        </h2>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
