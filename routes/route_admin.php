...
Route::group(['namespace' => 'backend','prefix'=>'admin'], function(){
    ...
    Route::prefix('article')->group(function(){
        ...
        Route::post('create','BackendArticleController@store')->name('get_backend.article.store');;
    ...
    Route::prefix('slide')->group(function(){
        ...
        Route::get('active/{id}','BackendSlideController@active')->name('get_backend.slide.active');
